		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t029",targetState="prepare",cond=whenEvent("prepare_button"))
					transition(edgeName="t030",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t031",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t032",targetState="exposefridge",cond=whenEvent("exposefridgestate_button"))
					transition(edgeName="t033",targetState="exposeroomstate",cond=whenEvent("exposeroomstate_button"))
					transition(edgeName="t034",targetState="handlerobotmsg",cond=whenDispatch("food_notavailable"))
				}	 
				...
				state("exposefridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t135",targetState="waitfridge",cond=whenReply("fridgestate"))
				}	 
				...
				state("exposeroomstate") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t236",targetState="waitroom",cond=whenReply("roomstate"))
				}	 
