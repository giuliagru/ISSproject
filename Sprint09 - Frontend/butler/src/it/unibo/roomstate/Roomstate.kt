		...
		return { //this:ActionBasciFsm
				...
				state("waitStateChange") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t17",targetState="handleexposeroomstate",cond=whenRequest("exposeroomstate"))
					transition(edgeName="t18",targetState="update",cond=whenDispatch("updateState"))
				}	 
