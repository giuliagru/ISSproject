...
action(take, fridge, food,[(Obj,N)|T]) :- on(fridge, food, Obj, X), Quantity is X-N, replaceRule(on(fridge, food, Obj, X), on(fridge, food, Obj, Quantity)), action(take, fridge, food, T). 
action(take, fridge, food, Obj, N) :- on(fridge, food, Obj, X), Quantity is X-N, replaceRule(on(fridge, food, Obj, X), on(fridge, food, Obj, Quantity)).
