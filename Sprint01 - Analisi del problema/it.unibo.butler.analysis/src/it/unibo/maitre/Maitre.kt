		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t015",targetState="prepare",cond=whenEvent("prepare_button"))
				}	 
				state("waitCmd") { //this:State
					action { //it:State
					}
					 transition(edgeName="t116",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t117",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t118",targetState="stoprobot",cond=whenEvent("stop_button"))
					transition(edgeName="t119",targetState="consultroom",cond=whenEvent("roomstate"))
					transition(edgeName="t120",targetState="handlerobotmsg",cond=whenDispatch("food_not_available"))
				}	 
				...
				state("add") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("add_button(Foodcode)"), Term.createTerm("add_button(X)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								println("Maitre | Requirement: ADD")
								updateResourceRep( "add"  
								)
								forward("add", "add(${payloadArg(0)})" ,"robot" ) 
						}
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t121",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
