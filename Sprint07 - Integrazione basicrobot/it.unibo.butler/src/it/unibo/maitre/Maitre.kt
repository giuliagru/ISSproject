		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="prepare",cond=whenEvent("prepare_button"))
				}	 
				state("waitCmd") { //this:State
					action { //it:State
					}
					 transition(edgeName="t131",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t132",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t133",targetState="stoprobot",cond=whenEvent("stop_button"))
					transition(edgeName="t134",targetState="consultroom",cond=whenEvent("roomstate"))
					transition(edgeName="t135",targetState="handlerobotmsg",cond=whenDispatch("food_notavailable"))
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t136",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
				...
				state("consultroom") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t237",targetState="waitroom",cond=whenReply("roomstate"))
				}	 
