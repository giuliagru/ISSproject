		...
		return { //this:ActionBasciFsm
				...
				state("waitStateChange") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t124",targetState="exposeroomstate",cond=whenRequest("exposeroomstate"))
					transition(edgeName="t125",targetState="update",cond=whenDispatch("updateState"))
				}	 
