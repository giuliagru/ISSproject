		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t018",targetState="check",cond=whenRequest("check_food"))
					transition(edgeName="t019",targetState="exposestate",cond=whenRequest("exposefridgestate"))
					transition(edgeName="t020",targetState="take",cond=whenDispatch("take_food"))
					transition(edgeName="t021",targetState="take",cond=whenDispatch("take_foodlist"))
				}	 
