		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="handleprepare",cond=whenDispatch("prepare"))
					transition(edgeName="t014",targetState="handleadd",cond=whenDispatch("add"))
					transition(edgeName="t015",targetState="handleclear",cond=whenDispatch("clear"))
				}	 
				state("handleprepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t116",targetState="atpantry",cond=whenDispatch("arrivedat"))
				}	 
				state("atpantry") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t217",targetState="attable_dishes",cond=whenDispatch("arrivedat"))
				}	 
				state("attable_dishes") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t318",targetState="atfridge",cond=whenDispatch("arrivedat"))
				}	 
				state("atfridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t519",targetState="attable_food",cond=whenDispatch("arrivedat"))
				}	 
				state("attable_food") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t620",targetState="endPrepare",cond=whenDispatch("arrivedat"))
				}	 
				...
				state("handleadd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t721",targetState="tofridge",cond=whenReply("food_available"))
					transition(edgeName="t722",targetState="alertMaitre",cond=whenReply("food_notavailable"))
				}	 
				state("tofridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t823",targetState="takefood",cond=whenDispatch("arrivedat"))
				}	 
				state("takefood") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1024",targetState="attable_food",cond=whenDispatch("arrivedat"))
				}	 
				...
				state("handleclear") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1125",targetState="cleartable_food",cond=whenDispatch("arrivedat"))
				}	 
				state("cleartable_food") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1226",targetState="leftoverstofridge",cond=whenDispatch("arrivedat"))
				}	 
				state("leftoverstofridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1327",targetState="cleartable_dishes",cond=whenDispatch("arrivedat"))
				}	 
				state("cleartable_dishes") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1428",targetState="dishestodishwasher",cond=whenDispatch("arrivedat"))
				}	 
				state("dishestodishwasher") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1529",targetState="endClear",cond=whenDispatch("arrivedat"))
				}	 
