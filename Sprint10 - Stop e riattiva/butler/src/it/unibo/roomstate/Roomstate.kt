		...
		return { //this:ActionBasciFsm
				...
				state("waitStateChange") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t111",targetState="handleexposeroomstate",cond=whenRequest("exposeroomstate"))
					transition(edgeName="t112",targetState="update",cond=whenDispatch("updateState"))
				}	 
				state("handleexposeroomstate") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("exposeroomstate(Cmd)"), Term.createTerm("exposeroomstate(Cmd)"), 
								...
								answer("exposeroomstate", "roomstate", "roomstate(${getCurSol("St")})"   )  
								}
								else
								{}
						}
