	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					...
					transition(edgeName="t09",targetState="handleexpose",cond=whenDispatch("expose"))
				}	 
				state("handleexpose") { //this:State
					action { //it:State
						forward("expose", "expose(x)" ,"roomstate" ) 
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
				state("handleprepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t110",targetState="atpantry",cond=whenReply("arrivedat"))
				}	 
				state("atpantry") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t211",targetState="attable_dishes",cond=whenReply("arrivedat"))
				}	 
				state("attable_dishes") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t312",targetState="atfridge",cond=whenReply("arrivedat"))
				}	 
				state("atfridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t513",targetState="attable_food",cond=whenReply("arrivedat"))
				}	 
				state("attable_food") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t614",targetState="endTask",cond=whenReply("arrivedat"))
				}	 
				...
				state("handleadd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t715",targetState="tofridge",cond=whenReply("food_available"))
					transition(edgeName="t716",targetState="alertMaitre",cond=whenReply("food_notavailable"))
				}	 
				state("tofridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t817",targetState="takefood",cond=whenReply("arrivedat"))
				}	 
				state("takefood") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1018",targetState="attable_food",cond=whenReply("arrivedat"))
				}	 
				...
				state("handleclear") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1119",targetState="cleartable_food",cond=whenReply("arrivedat"))
				}	 
				state("cleartable_food") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1220",targetState="leftoverstofridge",cond=whenReply("arrivedat"))
				}	 
				state("leftoverstofridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1321",targetState="cleartable_dishes",cond=whenReply("arrivedat"))
				}	 
				state("cleartable_dishes") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1422",targetState="dishestodishwasher",cond=whenReply("arrivedat"))
				}	 
				state("dishestodishwasher") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1523",targetState="endSession",cond=whenReply("arrivedat"))
				}	 
				state("endSession") { //this:State
					action { //it:State
						...
						forward("endSession", "endSession(X)" ,"maitre" ) 
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
			}
