		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t038",targetState="exposeroomstate",cond=whenEvent("exposeroomstate_button"))
					transition(edgeName="t039",targetState="prepare",cond=whenEvent("prepare_button"))
				}	 
				state("waitCmd") { //this:State
					action { //it:State
					}
					 transition(edgeName="t140",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t141",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t142",targetState="stoprobot",cond=whenEvent("stop_button"))
					transition(edgeName="t143",targetState="waitCmdPrepare",cond=whenDispatch("endSession"))
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t144",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
