		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t034",targetState="check",cond=whenRequest("check_food"))
					transition(edgeName="t035",targetState="exposestate",cond=whenRequest("exposefridgestate"))
					transition(edgeName="t036",targetState="take",cond=whenDispatch("take_food"))
					transition(edgeName="t037",targetState="take",cond=whenDispatch("take_foodlist"))
				}	 
