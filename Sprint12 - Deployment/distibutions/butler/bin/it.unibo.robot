...
##############################################################################
##
##  it.unibo.robot start up script for UN*X
##
##############################################################################
...
APP_NAME="it.unibo.robot"
APP_BASE_NAME=`basename "$0"`

# Add default JVM options here. You can also use JAVA_OPTS and IT_UNIBO_ROBOT_OPTS to pass JVM options to this script.
DEFAULT_JVM_OPTS=""
...
eval set -- $DEFAULT_JVM_OPTS $JAVA_OPTS $IT_UNIBO_ROBOT_OPTS -classpath "\"$CLASSPATH\"" it.unibo.ctxrobot.MainCtxrobotKt "$APP_ARGS"
