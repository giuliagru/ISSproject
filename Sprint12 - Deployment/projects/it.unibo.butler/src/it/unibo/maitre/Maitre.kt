	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					...
					transition(edgeName="t139",targetState="waitCmdPrepare",cond=whenDispatch("endSession"))
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t140",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
