		...
		return { //this:ActionBasciFsm
				...
				state("waitUpdate") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t041",targetState="updatefridge",cond=whenEvent("fridgestate"))
					transition(edgeName="t042",targetState="updateroom",cond=whenEvent("roomstate"))
					transition(edgeName="t043",targetState="updaterobotpos",cond=whenEvent("robotposition"))
					transition(edgeName="t044",targetState="updaterobotaction",cond=whenEvent("robotaction"))
					transition(edgeName="t045",targetState="updaterobotgoal",cond=whenEvent("robotgoal"))
					transition(edgeName="t046",targetState="handlerobotmsg",cond=whenEvent("food_notavailable"))
				}	 
