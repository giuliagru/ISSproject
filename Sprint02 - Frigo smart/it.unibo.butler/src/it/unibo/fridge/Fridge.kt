		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="check",cond=whenRequest("check_food"))
					transition(edgeName="t014",targetState="exposestate",cond=whenRequest("exposefridgestate"))
					transition(edgeName="t015",targetState="take",cond=whenDispatch("take_food"))
					transition(edgeName="t016",targetState="take",cond=whenDispatch("take_foodlist"))
				}	 
