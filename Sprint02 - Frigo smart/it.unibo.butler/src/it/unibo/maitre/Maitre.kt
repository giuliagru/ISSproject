		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t017",targetState="prepare",cond=whenEvent("prepare_button"))
				}	 
				state("waitCmd") { //this:State
					action { //it:State
					}
					 transition(edgeName="t118",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t119",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t120",targetState="stoprobot",cond=whenEvent("stop_button"))
					transition(edgeName="t121",targetState="consultroom",cond=whenEvent("roomstate"))
					transition(edgeName="t122",targetState="handlerobotmsg",cond=whenDispatch("food_notavailable"))
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t123",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
				...
				state("handlerobotmsg") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("food_notavailable(Foodcode,Quantity)"), Term.createTerm("food_not_available(Foodcode,Quantity)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
