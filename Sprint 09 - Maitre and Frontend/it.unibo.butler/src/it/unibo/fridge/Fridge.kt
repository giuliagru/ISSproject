		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="check",cond=whenRequest("check_food"))
					transition(edgeName="t031",targetState="exposestate",cond=whenRequest("exposefridgestate"))
					transition(edgeName="t032",targetState="take",cond=whenDispatch("take_food"))
					transition(edgeName="t033",targetState="take",cond=whenDispatch("take_foodlist"))
				}	 
