		...
		return { //this:ActionBasciFsm
				...
				state("waitStateChange") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t126",targetState="exposeroomstate",cond=whenRequest("exposeroomstate"))
					transition(edgeName="t127",targetState="update",cond=whenDispatch("updateState"))
				}	 
				...
				state("update") { //this:State
					action { //it:State
						...
						println("Room state | room has ${getCurSol("L")}")
					}
					 transition( edgeName="goto",targetState="waitStateChange", cond=doswitch() )
				}	 
			}
