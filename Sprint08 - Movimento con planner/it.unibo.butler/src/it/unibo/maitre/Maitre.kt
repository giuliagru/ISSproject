		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="prepare",cond=whenEvent("prepare_button"))
				}	 
				state("waitCmd") { //this:State
					action { //it:State
					}
					 transition(edgeName="t133",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t134",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t135",targetState="stoprobot",cond=whenEvent("stop_button"))
					transition(edgeName="t136",targetState="consultroom",cond=whenEvent("roomstate"))
					transition(edgeName="t137",targetState="handlerobotmsg",cond=whenDispatch("food_notavailable"))
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t138",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
				...
				state("consultroom") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t239",targetState="waitroom",cond=whenReply("roomstate"))
				}	 
				state("waitroom") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("roomstate(List)"), Term.createTerm("roomstate(List)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								println("Maitre | room state received: ${payloadArg(0)}")
						}
					}
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitch() )
				}	 
