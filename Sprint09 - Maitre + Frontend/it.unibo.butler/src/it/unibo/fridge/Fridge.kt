		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="check",cond=whenRequest("check_food"))
					transition(edgeName="t028",targetState="exposestate",cond=whenRequest("exposefridgestate"))
					transition(edgeName="t029",targetState="take",cond=whenDispatch("take_food"))
					transition(edgeName="t030",targetState="take",cond=whenDispatch("take_foodlist"))
				}	 
