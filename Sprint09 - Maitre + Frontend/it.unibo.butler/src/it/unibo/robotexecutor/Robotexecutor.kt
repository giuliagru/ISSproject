		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t05",targetState="handleprepare",cond=whenDispatch("prepare"))
					transition(edgeName="t06",targetState="handleadd",cond=whenDispatch("add"))
					transition(edgeName="t07",targetState="handleclear",cond=whenDispatch("clear"))
				}	 
				state("handleprepare") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("prepare(Cmd)"), Term.createTerm("prepare(X)"), 
								...
								emit("robotaction", "robotaction(PREPARE)" ) 
				...
				state("handleclear") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1117",targetState="cleartable_food",cond=whenReply("arrivedat"))
				}	 
				state("cleartable_food") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1218",targetState="leftoverstofridge",cond=whenReply("arrivedat"))
				}	 
				state("leftoverstofridge") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1319",targetState="cleartable_dishes",cond=whenReply("arrivedat"))
				}	 
				state("cleartable_dishes") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1420",targetState="dishestodishwasher",cond=whenReply("arrivedat"))
				}	 
				state("dishestodishwasher") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t1521",targetState="endTask",cond=whenReply("arrivedat"))
				}	 
			}
		}
}
