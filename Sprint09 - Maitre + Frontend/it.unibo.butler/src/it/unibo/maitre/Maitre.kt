		...
		return { //this:ActionBasciFsm
				...
				state("waitCmdPrepare") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t031",targetState="prepare",cond=whenEvent("prepare_button"))
				}	 
				state("waitCmd") { //this:State
					action { //it:State
					}
					 transition(edgeName="t132",targetState="add",cond=whenEvent("add_button"))
					transition(edgeName="t133",targetState="clear",cond=whenEvent("clear_button"))
					transition(edgeName="t134",targetState="stoprobot",cond=whenEvent("stop_button"))
				}	 
				...
				state("stoprobot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t135",targetState="reactivaterobot",cond=whenEvent("reactivate_button"))
				}	 
