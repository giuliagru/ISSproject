		...
		return { //this:ActionBasciFsm
				...
				state("waitStateChange") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t127",targetState="exposeroomstate",cond=whenRequest("exposeroomstate"))
					transition(edgeName="t128",targetState="expose",cond=whenDispatch("expose"))
					transition(edgeName="t129",targetState="update",cond=whenDispatch("updateState"))
				}	 
